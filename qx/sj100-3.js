...
if ($request.url.includes("/status/list")) {
  ...
  if (obj?.data?.info?.receipt?.in_app) {
    // 举例，给所有 in_app 数组里项目加一个 "is_trial_period": "false"
