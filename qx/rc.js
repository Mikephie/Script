...
[rewrite_local]
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-response-body https://raw.githubusercontent.com/Mikephie/Script/main/qx/rc.js
//^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-request-header https://raw.githubusercontent.com/Mikephie/Script/main/qx/rc.js
...
*/
const Mikephie = {};
const Mikephie1 = JSON.parse(typeof $response!= "undefined" && $response.body || null);
if (typeof $response == "undefined") {
  delete $request.headers["x-revenuecat-etag"];
  delete $request.headers["X-RevenueCat-ETag"];
  Mikephie.headers = $request.headers;
} else if (Mikephie1 && Mikephie1.subscriber) {
  Mikephie1.subscriber.subscriptions = Mikephie1.subscriber.subscriptions || {};
  Mikephie1.subscriber.entitlements = Mikephie1.subscriber.entitlements || {};
  var headers = {};
